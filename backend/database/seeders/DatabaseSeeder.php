...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // 1. Seed settings safely
        Setting::firstOrCreate(['key' => 'app_name'], ['value' => 'NagarRakshak']);
        Setting::firstOrCreate(['key' => 'contact_email'], ['value' => 'support@nagarrakshak.org']);
        Setting::firstOrCreate(['key' => 'alert_radius'], ['value' => '500']);
        Setting::firstOrCreate(['key' => 'critical_threshold'], ['value' => '10']);
        Setting::firstOrCreate(['key' => 'auto_escalation'], ['value' => '1']);
        Setting::firstOrCreate(['key' => 'confidence_threshold'], ['value' => '0.7']);
        Setting::firstOrCreate(['key' => 'auto_classification'], ['value' => '1']);
        Setting::firstOrCreate(['key' => 'auto_severity_detection'], ['value' => '1']);
        Setting::firstOrCreate(['key' => 'classification_prompt'], ['value' => 'Analyze this image and classify any public safety hazard.']);

        // 2. Seed Categories safely
        Category::firstOrCreate(['name' => 'Pothole'], ['description' => 'Deformation or cavity in road surface.', 'icon' => 'fa-road', 'is_active' => true]);
        Category::firstOrCreate(['name' => 'Open Drain'], ['description' => 'Uncovered roadside gutter drainage.', 'icon' => 'fa-water', 'is_active' => true]);
        Category::firstOrCreate(['name' => 'Open Manhole'], ['description' => 'Missing utility cover on main pathway.', 'icon' => 'fa-circle-dot', 'is_active' => true]);
        Category::firstOrCreate(['name' => 'Waterlogging'], ['description' => 'Flooded road section blocking traffic.', 'icon' => 'fa-cloud-showers-heavy', 'is_active' => true]);
        Category::firstOrCreate(['name' => 'Broken Streetlight'], ['description' => 'Outage causing dark zones on road stretches.', 'icon' => 'fa-lightbulb', 'is_active' => true]);
        Category::firstOrCreate(['name' => 'Garbage'], ['description' => 'Public trash pile blocking routes.', 'icon' => 'fa-trash', 'is_active' => true]);

        // 3. Seed Admins and Citizens safely
        $admin = User::firstOrCreate(['email' => 'admin@nagarrakshak.org'], [
            'name' => 'City Admin',
        ...
        $user1 = User::firstOrCreate(['email' => 'aarav@nagarrakshak.org'], [
            'name' => 'Aarav Sharma',
            'password' => Hash::make('password'),
        ...
        $user2 = User::firstOrCreate(['email' => 'priya@nagarrakshak.org'], [
            'name' => 'Priya Patel',
            'password' => Hash::make('password'),
        ...
        $user3 = User::firstOrCreate(['email' => 'rohan@nagarrakshak.org'], [
            'name' => 'Rohan Verma',
            'password' => Hash::make('password'),
        ...
        // 4. Seed Hazards (Cases) and related data only if empty
        if (Hazard::count() === 0) {
